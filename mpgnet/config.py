...
def add_mpgnet_config(cfg):
    ...
    _C.MODEL.ROI_BOX_HEAD.DETECTION_WEIGHT_PATH = 'datasets/metadata/lvis_v1_clip_a+cname.npy'
    ...
    _C.MODEL.ROI_BOX_HEAD.CLS_AGNOSTIC_BBOX_REG = False#新加的
    _C.MODEL.ROI_HEADS.NUM_CLASSES = 8#新加的
    _C.MODEL.ROI_BOX_HEAD.L2_LOSS_WEIGHT = 0.1#新加的L2损失权重
    _C.MODEL.ROI_BOX_HEAD.TRIPLET_LOSS_WEIGHT = 0.1
    _C.MODEL.ROI_BOX_HEAD.TRIPLET_LOSS_MARGIN = 1.0
    ...
    _C.MODEL.ROI_BOX_HEAD.NEG_CAP_WEIGHT = 1.25 # Caption loss hyper-parameter
    _C.MODEL.ROI_BOX_HEAD.HARD_NEG_CAP_WEIGHT = 0.125
    ...
    _C.MODEL.ROI_BOX_HEAD.USE_TEXT_GUIDANCE = False
    ...
    _C.DATALOADER.CONCEPT_GROUP_SIZE = 8
    ...
    _C.MODEL.DETR.ZEROSHOT_WEIGHT_PATH = None
    _C.MODEL.DETR.CAT_FREQ_PATH = 'datasets/metadata/lvis_v1_train_cat_info.json'
