...
from mpgnet.config import add_mpgnet_config
from mpgnet.data.custom_build_augmentation import build_custom_augmentation
from mpgnet.data.custom_dataset_dataloader import  build_custom_train_loader
from mpgnet.data.custom_dataset_mapper import CustomDatasetMapper, DetrDatasetMapper
from mpgnet.custom_solver import build_custom_optimizer
from mpgnet.evaluation.oideval import OIDEvaluator
from mpgnet.evaluation.custom_coco_eval import CustomCOCOEvaluator
from mpgnet.modeling.utils import reset_cls_test
...
def setup(args):
    ...
    setup_logger(output=cfg.OUTPUT_DIR, \
        distributed_rank=comm.get_rank(), name="mpgnet")
    return cfg
